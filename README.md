BootloadHID
===========
Modifications compared to [ajd4096/bootloadHID](https://github.com/ajd4096/bootloadHID):
* on build you can set `IDENT_VENDOR_NUM` `IDENT_PRODUCT_NUM` by doing `make VENDORID=<vendorid> PRODUCTID=<productid>`
